...
import { AddPlacePhotoDetails } from "./add-place-photo-details/AddPlacePhotoDetails";
import { SectionHeader } from "../../common/section-header/SectionHeader";

export function AddPlacePhoto({ photos, setPhotos, localization }) {
